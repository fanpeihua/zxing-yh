...
```gradle
//AndroidX 版本
implementation 'com.yonghui.zxing:zxing-lite:1.1.9-androidx'
...
### Lvy:
```lvy
<dependency org='com.yonghui.zxing' name='zxing-lite' rev='1.1.9'>
...
```Xml
    <activity
        android:name="com.yonghui.zxing.CaptureActivity"
